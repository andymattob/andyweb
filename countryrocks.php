...
<head>
	<meta charset="utf-8">
	<title>Gamesphere - Country Rocks</title>
...
<div class="radio_up">
    <p>Country Rocks</p>
    <div class="nytt">
    <img src="https://countryrocksradio.com/images/CRR_web.png" class="radiologo2"><img src="img/listenlive.jpg" onclick="document.getElementById('player').play()">
  <nav class="menuradio">
      <ul class="menu-listradio">
      <li><a href="countryrocks.php">Startsida</a></li> 
      <li><a href="#">Låtlista</a></li>
      </ul>
        </nav>
    <div class="webplayer">
<audio controls id="player">
   <source src="https://stream.dbmedia.se/crrMP3" type="audio/mpeg">
</audio>
        </div>
    </div>
    </div>
