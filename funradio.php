...
<head>
	<meta charset="utf-8">
	<title>Gamesphere - Fun Radio</title>
...
<div class="radio_up">
    <p>Fun Radio</p>
    <div class="nytt">
    <img src="https://funradio.se/wp-content/uploads/2017/06/header3-1.png" class="radiologo"><img src="img/listenlive.jpg" onclick="document.getElementById('player').play()">
  <nav class="menuradio">
      <ul class="menu-listradio">
      <li><a href="funradio.php">Startsida</a></li> 
      <li><a href="#">Låtlista</a></li>
      </ul>
        </nav>
    <div class="webplayer">
<audio controls id="player">
   <source src="https://s4.radioforge.com:3038/live128" type="audio/mpeg">
</audio>
        </div>
    </div>
    </div>
