...
<head>
	<meta charset="utf-8">
	<title>Gamesphere - Piraterock</title>
	<meta name="author" content="Andreas">
	<meta name="description" content="Gamesphere">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<link rel="stylesheet" href="css/back.css">
    <link rel="stylesheet" href="css/menu.css">
    <link rel="stylesheet" href="css/radio_menu.css">
...
<div class="radio_up">
    <p>Piraterock</p>
    <div class="nytt">
    <img src="https://piraterock.se/wp-content/uploads/2018/05/PR-Logo-300x189.png" class="radiologo2"><img src="img/listenlive.jpg" onclick="document.getElementById('player').play()">
  <nav class="menuradio">
      <ul class="menu-listradio">
      <li><a href="piraterock.php">Startsida</a></li> 
      <li><a href="#">Låtlista</a></li>
      </ul>
        </nav>
    <div class="webplayer">
<audio controls id="player">
   <source src="https://stream.piraterock.se:8100/webradio" type="audio/mpeg">
</audio>
        </div>
    </div>
    </div>
