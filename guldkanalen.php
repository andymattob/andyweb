...
<head>
	<meta charset="utf-8">
	<title>Gamesphere - Guldkanalen</title>
...
<div class="radio_up">
    <p>Guldkanalen</p>
    <div class="nytt">
    <img src="https://guldkanalen.se/wp-content/uploads/2022/10/uppe_logo.png" class="radiologo2"><img src="img/listenlive.jpg" onclick="document.getElementById('player').play()">
  <nav class="menuradio">
      <ul class="menu-listradio">
      <li><a href="guldkanalen.php">Startsida</a></li> 
      <li><a href="#">Låtlista</a></li>
      </ul>
        </nav>
    <div class="webplayer">
<audio controls id="player">
   <source src="https://stream.dbmedia.se/gkMP3" type="audio/mpeg">
</audio>
        </div>
    </div>
    </div>
