...
//You can configure your cost value according to your server configuration.By Default value is 10.
  ...
  // Verifying Post password againt stored password
   if(password_verify($storedpass,$hash)){
    ...
    echo "<script>alert('Fel löseord');</script>";
    ...
    echo "<script>alert('Ogiltiga detaljer');</script>";
  }
}
?>
                      ...
                      <div class="well">
                          <form id="loginForm" method="post">
                              <div class="form-group">
                                  <input type="text" class="form-control" id="username" name="username"  required="" title="Skriv in användarnamn eller Email" placeholder="email eller Användarnamn" >
                                  <span class="help-block"></span>
                              </div>
                              <div class="form-group">
                                  <input type="password" class="form-control" id="password" name="password" placeholder="Lösenord" value="" required="" title="Skriv in lösenord">
                                  <span class="help-block"></span>
                              </div>
                           
                              <button type="submit" class="btn btn-success btn-block" name="login">Logga in</button>
                              </br>
                              <p>Har du ingen registrering, </br></br><a href="signup.php" class="btn btn-info btn-block">Registrera här!</a></p>
                          </form>
                      </div>
                  </div>
              </div>
