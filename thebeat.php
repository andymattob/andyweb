...
<head>
	<meta charset="utf-8">
	<title>Gamesphere - The Beat</title>
...
<div class="radio_up">
    <p>The Beat</p>
    <div class="nytt">
    <img src="http://thebeat.se/wp-content/uploads/2022/07/thebeattransparent_crop.png" class="radiologo"><img src="img/listenlive.jpg" onclick="document.getElementById('player').play()">
  <nav class="menuradio">
      <ul class="menu-listradio">
      <li><a href="thebeat.php">Startsida</a></li> 
      <li><a href="#">Låtlista</a></li>
      </ul>
        </nav>
    <div class="webplayer">
<audio controls id="player">
   <source src="https://soundicradio.radioca.st/stream" type="audio/mpeg">
</audio>
        </div>
    </div>
    </div>
