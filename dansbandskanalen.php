...
<head>
	<meta charset="utf-8">
	<title>Gamesphere - Dansbandskanalen</title>
...
<div class="radio_up">
    <p>The Beat</p>
    <div class="nytt">
    <img src="https://dansbandskanalen.se/wp-content/uploads/2021/10/logo.png" class="radiologo2"><img src="img/listenlive.jpg" onclick="document.getElementById('player').play()">
  <nav class="menuradio">
      <ul class="menu-listradio">
      <li><a href="dansbandskanalen.php">Startsida</a></li> 
      <li><a href="#">Låtlista</a></li>
      </ul>
        </nav>
    <div class="webplayer">
<audio controls id="player">
   <source src="https://stream.dbmedia.se/dbkMP3" type="audio/mpeg">
</audio>
        </div>
    </div>
    </div>
